...
extern const wchar_t* COMP_BASE = TEXT("InputComponentBase");

//---------------------------------------------------------------------------//

InputComponentBase::InputComponentBase(IUnknown* pUnkOuter)
{
...
HRESULT __stdcall InputComponentBase::QueryInterface
(
...
ULONG __stdcall InputComponentBase::AddRef()
{
...
ULONG __stdcall InputComponentBase::Release()
{
...
REFCLSID __stdcall InputComponentBase::ClassID() const
{
...
LPCWSTR __stdcall InputComponentBase::Name() const
{
    return COMP_NAME;
}
...
IComponent* __stdcall InputComponentBase::Owner() const
{
    if ( m_owner )
    {
        m_owner->AddRef();
...
IPropManager* __stdcall InputComponentBase::PropManager() const
{
    if ( m_prop_mgr )
    {
        m_prop_mgr->AddRef();
...
STATE __stdcall InputComponentBase::Status() const
{
    return m_state;
}
...
HRESULT __stdcall InputComponentBase::Attach
(
...
HRESULT __stdcall InputComponentBase::Detach
(
    LPCWSTR msg, IComponent* listener
)
{
...
HRESULT __stdcall InputComponentBase::GetInstance
(
...
HRESULT __stdcall InputComponentBase::Notify
(
    IMsgObject* msg_obj
)
{
...
HRESULT __stdcall InputComponentBase::Start
(
...
HRESULT __stdcall InputComponentBase::Stop
(
    IComponent* listener
)
{
...
HRESULT __stdcall InputComponentBase::Close
(
    IComponent* listener
)
{
...
HRESULT __stdcall InputComponentBase::Open
(
...
HRESULT __stdcall InputComponentBase::QuerySupport
(
...
HRESULT __stdcall InputComponentBase::Seek
(
...
HRESULT __stdcall InputComponentBase::Read
(
